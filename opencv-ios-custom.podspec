Pod::Spec.new do |s|
  ...
  s.source = {
    :http => 'https://github.com/jfreyer/opencv-ios-custom/releases/download/4.12.0-1/opencv2.xcframework.zip',
    :sha256 => 'efbb4909bef13cf0046897fbe9377ad2875537519f6c174e4a98b756d0ff0f8a'
  }
  s.platform         = :ios, '13.0'
